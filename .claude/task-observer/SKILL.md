...
_Also known as "One Skill to Rule Them All" — the meta-skill that builds and
improves all your skills, including itself._
...
request against skill descriptions, a skill that monitors _all_ tasks can be
...
resolved in a _previous SESSION or prior log write_, not entries marked
...
and all OPEN entries plus any entries that were _just_ marked ACTIONED or
